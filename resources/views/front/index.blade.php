  ...
  <body>
    ...
    <section id="intro" style="background: url(front/img/home.webp) center center no-repeat; background-size: cover;" class="intro-section pb-2">
      <div class="container text-center">
        ...
        <p data-animate="slideInUp" class="h3 text-shadow text-400">I am here to make beautiful, insightful, 100% secure, efficiant and SEO friendly websites for <strong>YOU</strong></p>
      </div>
    </section>
        ...
        <div class="row">
          <div data-animate="fadeInUp" class="col-lg-6">
            <p>I am Sachin Pandey, a Junior year B.Tech (CS&E) student from BBD University, Lucknow. 
              <br><br>Professionally, I am a full-stack web developer and like tinkering with datasets to reveal the patterns they're hiding, which can then be used to optimize a problem. 
            ...
            <ul class="timeline" style="margin-top: 40px;">
                <li data-animate="slideInUp">
                    ...
                    <div class="timeline-panel">
                        ...
                        <div class="timeline-body"><p class="text-muted">It was a science magazine company, started by me and 2 other friends of mine. I was in the role of chief technology office. I single-handidly developed the website and did other technical works. But due to lack of resources and time, we had to eventually shut it down.</p></div>
                    </div>
                </li>
      ...
      <div class="container">
        ...
        <div class="row services text-center">
          <div data-animate="fadeInUp" class="col-lg-4">
            ...
            <p class="text-left description">I build beautiful, affordable, user-friendly, insightful, 100% secure, efficiant and SEO friendly websites for my respected clients. 
          ...
          <div data-animate="fadeInUp" class="col-lg-4">
            ...
            <p class="text-left description">I know a bunch of programming languages like C, C++, Java, PHP etc. but <b>Python</b> is most beloved to me. It is my favourite programming language. It is easy, take relatively less time, secure and can be used to write or interface with a multitude of application. For these reasons I've been actively developing using Python since 2019.</p>
          </div>
          <div data-animate="fadeInUp" class="col-lg-4">
            <div class="icon"><i class="fa fa-tachometer"></i></div>
            <h3 class="heading mb-3 text-400">Data Science/Data Vizualisation</h3>
            <p class="text-left description">I won't lie, I like data science, but currently I don't have much knowledge and experience in this field. Although, I am continuously learning, but still I am just a Data scientist beginner.</p>
          </div>
        </div>
